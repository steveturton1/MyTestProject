...
def get_toolbar():
    ...
    shirt['img_medium'] = url_for('static', filename='images/shirts/anvil-white-medium.jpg')
    shirts.append(shirt)
    ...
    shirt['img_medium'] = url_for('static', filename='images/shirts/anvil-black-medium.jpg')
    shirts.append(shirt)
